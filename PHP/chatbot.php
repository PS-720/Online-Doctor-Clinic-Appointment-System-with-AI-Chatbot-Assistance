...
$responses = [
    ...
    'back' => ['For back pain or spinal discomfort, an **Orthopedic** specialist is recommended.', 'Orthopedic'],
    ...
    'cold' => ['Common cold symptoms can usually be treated by a **General Physician**.', 'General Physician'],
    'cough' => ['A persistent cough should be evaluated by a **General Physician**.', 'General Physician'],
    'stomach' => ['Stomach pain or digestive issues should be evaluated by a **General Physician**.', 'General Physician'],
    'pain' => ['For pain management or general diagnosis, it is best to consult a **General Physician**.', 'General Physician'],
